...
class FormdataurlencodedOperations(object):
    ...
    def update_pet_with_form(
        self,
        pet_id,  # type: int
        pet_type,  # type: Union[str, "_models.PostContentSchemaPetType"]
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.update_pet_with_form.metadata["url"]  # type: ignore
        path_format_arguments = {
            "petId": self._serialize.url("pet_id", pet_id, "int"),
        }
