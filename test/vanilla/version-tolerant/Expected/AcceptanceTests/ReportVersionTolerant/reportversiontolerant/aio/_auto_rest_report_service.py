...
class AutoRestReportService(AutoRestReportServiceOperationsMixin):
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `reportversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from reportversiontolerant.rest import build_get_report_request
