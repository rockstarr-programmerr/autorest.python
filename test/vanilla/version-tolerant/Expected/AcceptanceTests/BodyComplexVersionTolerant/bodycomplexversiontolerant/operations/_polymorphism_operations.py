...
class PolymorphismOperations(object):
    ...
    def get_valid(
        ...
        request = rest_polymorphism.build_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
    ...
    def get_dot_syntax(
        ...
        :rtype: ~bodycomplexversiontolerant.models.DotFish
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_composed_with_discriminator(
        ...
        :rtype: ~bodycomplexversiontolerant.models.DotFishMarket
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_complicated(
        ...
        :rtype: ~bodycomplexversiontolerant.models.Salmon
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def put_complicated(
        ...
        **kwargs  # type: Any
        ...
        :param complex_body:
        :type complex_body: ~bodycomplexversiontolerant.models.Salmon
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
