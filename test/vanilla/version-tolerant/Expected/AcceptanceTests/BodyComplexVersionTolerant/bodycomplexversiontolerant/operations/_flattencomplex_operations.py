...
from ..rest import flattencomplex as rest_flattencomplex
...
class FlattencomplexOperations(object):
    ...
    def get_valid(
        ...
        request = rest_flattencomplex.build_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
