...
class BasicOperations(object):
    ...
    def get_valid(
        ...
        :rtype: ~bodycomplexversiontolerant.models.Basic
        ...
        request = rest_basic.build_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
    ...
    def put_valid(
        ...
        **kwargs  # type: Any
        ...
        :type complex_body: ~bodycomplexversiontolerant.models.Basic
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def get_invalid(
        ...
        request = rest_basic.build_get_invalid_request(template_url=self.get_invalid.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
    ...
    def get_empty(
        ...
        request = rest_basic.build_get_empty_request(template_url=self.get_empty.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
    ...
    def get_null(
        ...
        request = rest_basic.build_get_null_request(template_url=self.get_null.metadata["url"], **kwargs)
        request.url = self._client.format_url(request.url)
