...
class Basic(msrest.serialization.Model):
    ...
    :type color: str or ~bodycomplexversiontolerant.models.CMYKColors
    """
...
class Cat(Pet):
    ...
    :type color: str
    :param hates:
    :type hates: list[~bodycomplexversiontolerant.models.Dog]
    """
...
class Fish(msrest.serialization.Model):
    ...
    :type length: float
    :param siblings:
    :type siblings: list[~bodycomplexversiontolerant.models.Fish]
    """
...
class DotFishMarket(msrest.serialization.Model):
    ...
    :param sample_salmon:
    :type sample_salmon: ~bodycomplexversiontolerant.models.DotSalmon
    :param salmons:
    :type salmons: list[~bodycomplexversiontolerant.models.DotSalmon]
    :param sample_fish:
    :type sample_fish: ~bodycomplexversiontolerant.models.DotFish
    :param fishes:
    :type fishes: list[~bodycomplexversiontolerant.models.DotFish]
    """
...
class Goblinshark(Shark):
    ...
    :param color: Colors possible. Possible values include: "pink", "gray", "brown", "RED", "red".
     Default value: "gray".
    :type color: str or ~bodycomplexversiontolerant.models.GoblinSharkColor
    """
...
class MyBaseType(msrest.serialization.Model):
    ...
    :type kind: str or ~bodycomplexversiontolerant.models.MyKind
    :param prop_b1:
    :type prop_b1: str
    :param prop_bh1:
    :type prop_bh1: str
