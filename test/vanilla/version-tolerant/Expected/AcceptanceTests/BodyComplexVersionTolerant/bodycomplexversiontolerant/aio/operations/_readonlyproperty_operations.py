...
class ReadonlypropertyOperations:
    ...
    async def get_valid(self, **kwargs: Any) -> "_models.ReadonlyObj":
        ...
        request = rest_readonlyproperty.build_get_valid_request(template_url=self.get_valid.metadata["url"], **kwargs)
    ...
    @distributed_trace_async
    async def put_valid(self, complex_body: "_models.ReadonlyObj", **kwargs: Any) -> None:
