...
class AdditionalPropertiesClient(object):
    ...
    :vartype pets: additionalpropertiesversiontolerant.operations.PetsOperations
    ...
    def send_request(
        ...
        **kwargs  # type: Any
        ...
        >>> from additionalpropertiesversiontolerant.rest import build_create_ap_true_request
        >>> request = build_create_ap_true_request(json, content, **kwargs)
