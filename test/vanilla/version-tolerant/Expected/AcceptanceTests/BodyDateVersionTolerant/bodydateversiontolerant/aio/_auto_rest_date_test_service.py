...
class AutoRestDateTestService:
    ...
    :vartype date: bodydateversiontolerant.aio.operations.DateOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydateversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from bodydateversiontolerant.rest import date
    ...
    async def __aenter__(self) -> "AutoRestDateTestService":
