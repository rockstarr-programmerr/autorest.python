...
class AutoRestIntegerTestService:
    ...
    :vartype int: bodyintegerversiontolerant.aio.operations.IntOperations
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyintegerversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from bodyintegerversiontolerant.rest import int
