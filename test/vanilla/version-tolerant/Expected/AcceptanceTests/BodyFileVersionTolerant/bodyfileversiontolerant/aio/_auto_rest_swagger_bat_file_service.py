...
class AutoRestSwaggerBATFileService:
    ...
    :vartype files: bodyfileversiontolerant.aio.operations.FilesOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodyfileversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from bodyfileversiontolerant.rest import files
