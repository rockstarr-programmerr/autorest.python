...
class AutoRestDateTimeTestService:
    ...
    :vartype datetime: bodydatetimeversiontolerant.aio.operations.DatetimeOperations
    ...
    def send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodydatetimeversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from bodydatetimeversiontolerant.rest import datetime
