...
class AutoRestSwaggerBATDictionaryService(object):
    ...
    def send_request(
        ...
        **kwargs  # type: Any
        ...
        We have helper methods to create requests specific to this service in `bodydictionaryversiontolerant.rest`.
        Use these helper methods to create the request you pass to this method. See our example below:

        >>> from bodydictionaryversiontolerant.rest import dictionary
    ...
    def __enter__(self):
        # type: () -> AutoRestSwaggerBATDictionaryService
