...
class AutoRestTimeTestService:
    ...
    :vartype time: bodytimeversiontolerant.aio.operations.TimeOperations
    ...
    def _send_request(self, request: HttpRequest, **kwargs: Any) -> Awaitable[AsyncHttpResponse]:
        ...
        We have helper methods to create requests specific to this service in `bodytimeversiontolerant.rest`.
    ...
    async def __aenter__(self) -> "AutoRestTimeTestService":
